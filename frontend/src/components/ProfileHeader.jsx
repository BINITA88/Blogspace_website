...
//     border: 'none'
//   }}
//   className='hover:opacity-90 text-white py-2 px-4 rounded-full transition duration-300 flex items-center justify-center'
// >
...
// 							className='w-full  text-white py-2 px-4 rounded-full hover:bg-primary-dark
...
//   style={{ backgroundColor: '#159A9C' }}
//   className="w-full text-white py-2 px-4 rounded-full hover:bg-primary-dark transition duration-300"
// >
//   Edit Profile
// </button>
...
import { axiosInstance } from "../lib/axios";
import { toast } from "react-hot-toast";
import { Camera, Clock, MapPin, UserCheck, UserPlus, X, Mail, Lock } from "lucide-react";
    ...
    switch (getConnectionStatus) {
      ...
      default:
        return (
          <button
            onClick={() => sendConnectionRequest(userData._id)}
            style={{ backgroundImage: "linear-gradient(to right, #159A9C, #76C7C5)", border: "none" }}
            className="hover:opacity-90 text-white py-2 px-4 rounded-full transition duration-300 flex items-center justify-center"
          >
              ...
              <div className="flex flex-col items-center gap-4 mt-4">
                <div className="relative w-72">
                  ...
                  <input
                    ...
                    value={editedData.location ?? userData.location}
                    onChange={(e) => setEditedData({ ...editedData, location: e.target.value })}
                    className="w-full text-center pl-10 pr-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 shadow-md focus:outline-none focus:ring-2 focus:ring-[#159A9C] transition duration-200"
                  />
                </div>
                {/* <div className="relative w-72">
                  ...
                  <input
                    ...
                    placeholder="Email"
                    disabled
                    className="w-full text-center pl-10 pr-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 shadow-md"
                  />
                </div>
                <div className="relative w-72">
